...
class InventoryApp(ctk.CTkFrame):
    ...
    def _detect_category(self) -> str:
        ...
        if 'oilseals' in module_name:
            return 'OIL SEALS'
        elif 'monoseals' in module_name and 'wipermono' not in module_name:
            return 'MONOSEALS'
    ...
    def _get_product_type_label(self) -> str:
        ...
        if 'MONOSEALS' in category:
            return 'Monoseal'
        elif 'WIPER' in category and 'WIPERMONO' not in category:
            return 'Wiper Seal'
        elif 'WIPERMONO' in category:
            return 'Wipermono'
        return 'Product'
    ...
    def _get_status_label_text(self, count: int) -> str:
        ...
        if 'MONOSEALS' in category:
            ...
            return f"Total Wipermono Products: {count}"
