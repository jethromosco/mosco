...
class AdminPanel:
    ...
    def _get_product_form_handler_class(self, base_folder=None):
        ...
        # Fallback to oilseals if anything fails
        try:
            fallback_module = importlib.import_module('oilseals.gui.gui_prod_aed')
    ...
    def create_products_tab(self):
        ...
        ProductFormHandlerClass = self._get_product_form_handler_class('oilseals')
